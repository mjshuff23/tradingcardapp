import { levenshteinSimilarity, tokenCoverageScore } from '../src/common/similarity.util';
...
describe('similarity.util', () => {
  ...
  it('computes token coverage score', () => {
    const coverage = tokenCoverageScore('1993 michael jordan upper deck', 'michael jordan upper deck');
